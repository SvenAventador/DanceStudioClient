        ...
        <footer className="footer">
            <div className="footer__container">
                    ...
                    <div className="footer__section">
                        ...
                        <div className="footer__social">
                            ...
                            <a href="/" className="footer__link">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35"
                                     viewBox="0 0 48 48">
                                    <linearGradient id="Byy22pnmlYaI5cW_~l8WCa_6P1pA3HJabYU_gr1" x1="18.188" x2="29.446"
                                                    y1="6.001" y2="40.865" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#33bef0"></stop>
                                        <stop offset="1" stop-color="#0a85d9"></stop>
                                    </linearGradient>
                ...
                <div className="footer__bottom">
                    <p className="footer__copyright">© {new Date().getFullYear()} BD Dance. Все права защищены</p>
                </div>
